    ...
    <div class="container">
        ...
        <div class="row height-custom justify-content-center py-5">
            <div class="col-12 col-md-6">
                ...
                @else
                    <img src="https://picsum.photos/400" class="d-block w-100 rounded shadow" alt="Nessuna foto inserita dall'utente">      
                @endif
            </div>
            <div class="col-12 col-md-6 mb-5 height-custom text-center ">
                <h2 class="display-5"><span class="fw-bold">Titolo: </span>{{$article->title}}</h2>
                <div class="d-flex flex-column justify-content-center h-75">
                    <h4 class="fw-bold my-5">Prezzo: {{$article->price}} €</h4>
                    <h5>Descrizione:</h5>
